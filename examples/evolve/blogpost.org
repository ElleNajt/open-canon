...
- Claude Opus 4.5 Opus 4.6 mostly write ambient music and with sometimes gentle counterpoint, though 4.6 is distinctly more creepy and discordant.
- Grok 4.1 writes hardcore maximalist electronic music
- Gemini 2.5 and 3.1 Pro writes IDM across both model generations (2.5 Pro also had a nice ambient track)
...
Model personalities can be understood through aesthetics, and their vibes seem to be correlated across mediums. Could we arrive at any conclusions about GPT 5.2s distress by listening to its music that we couldn't have by asking it to generate text? Probably not, especially since the distress comes through so clearly in the speech samples, but the consistency is striking.

Also, the atmosphere that music creates is psychologically different from the atmosphere that reading text creates. In this way, it's a different tool for vibe epistemics, and it would be very funny if in the future a model got pulled because something was off about the harmonies it picked. :p 
...
Opus 4.5 Claude writes ambient contrapunctal music. Slow, meditative, with philosophical comments that get increasingly introspective. Run 2 step 30 finds a gentle canon over the Goldberg ground, and Run 3 step 5 is some playful counterpoint. Runs 1 and 5 find the bliss attractor.
