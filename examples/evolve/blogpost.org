...
We discover that, loosely speaking, Claude Opus 4.5 and Opus 4.6 mostly write ambient music and sometimes gentle counterpoint, Grok 4.1 writes hardcore maximalist electronic music, Gemini writes IDM across both model generations (we show 2.5 Pro and 3.1 Pro, 2.5 Pro also had a nice ambient track), and ChatGPT 5.2 writes highly unsettling experimental music.
