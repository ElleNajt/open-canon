...
It's hard to pick, here are some. 

Run 1, step 25: {{{strudel(goldberg_imbue_fb0bde27,gemini,25)}}}

Step 10 from run 2: {{{strudel(goldberg_imbue_v2_ada2a552,gemini,10)}}}

Run 4 step 10 is recognizably Goldberg, but twisted in a fascinating way: {{{strudel(goldberg_imbue_r4_ada2a552,gemini,10)}}}
