...
and hear what changes. Every step of every run is linked below.
...
** ChatGPT 4.1 (=openai/gpt-4.1=, older model)

I wasn't super impressed by ChatGPT 4.1.
...
** Cross-model: GPT 4.1 x Gemini (alternating, older model)
