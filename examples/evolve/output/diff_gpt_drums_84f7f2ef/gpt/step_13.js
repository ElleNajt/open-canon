...
$: arrange(
  ...
  .djf(sine.range(0.04, 0.96).slow(24))
  .swing(0.13)
  .every(8, p => p.rev().sometimes(q => q.fast(2).degradeBy(0.24)).sometimes(r => r.ply(2)).sometimesBy(0.35, t => t.degradeBy(0.18)))
...
$: arrange(
  ...
  .hpf(sine.range(3800, 9800).slow(18))
...
$: arrange(
  ...
  [16, s("<keep_drifting stay_weird> ~ <signal_in_the_noise ~> <turn_the_dial ~>")],
