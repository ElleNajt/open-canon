...
$: arrange(
  ...
  .djf(sine.range(0.12, 0.88).slow(16))
  .swing(0.14)
  .every(8, p => p.rev())
...
$: arrange(
  ...
  .hpf(sine.range(3600, 10600).slow(16))
  .pan(perlin.range(0.12, 0.88).slow(12))
  .gain(0.11)
  .swing(0.18)
...
$: note("<c2 ~> <c2 c3> <eb2 eb1> <g1 ~> <bb1 ~> <ab1 g1> <c2 bb1> ~ <c2 g1> <ab1 ~> <g1 ~> <c2 ~> <c2 c3> <eb2 ~> <g1 ~> <bb1 c2>")
  .sound("pulse")
  .lpf(perlin.range(120, 2200).slow(15))
  .penv(0.22)
  .slide(0.12)
  .gain(0.23)
  .every(6, p => p.transpose(-12).sometimes(q => q.transpose(12)))

$: note("<c4 eb4 g4 bb4> <bb3 db4 f4 ab4> <ab3 c4 eb4 gb4> <g3 bb3 d4 f4> <eb4 g4 bb4 c5> <ab3 c4 eb4 gb4> <g3 bb3 d4 f4> <c4 eb4 g4 bb4>")
  .sound("supersaw")
  .slow(6)
  .lpf(sine.range(520, 2800).slow(12))
  .room(0.22)
  .gain(0.10)
  .juxBy(0.55, p => p.transpose(12).detune(9).lpf(sine.range(900, 3600).slow(9)))
