...
$: stack(
  ...
  .every(6, p => p.transpose(7).late(0.125))
...
$: note("<d4 e4 fs4 g4 a4 b4 c5 b4> <d4 <e4 fs4> ~ g4 <a4 bb4> ~ <b4 a4> <c5 bb4>> <d4 fs4 a4 b4> <c5 b4 a4 <g4 e4>> <d4 e4 <fs4 a4> g4 <fs4 ~> b4 c5 ~> <d5 ~ <b4 c5> a4 g4 <fs4 e4> <d4 ~>>")
  ...
  .lpf(sine.range(800, 6400).slow(12))
...
$: note("<g4 d5 bb4 g5> <fs4 cs5 a4 fs5> <e4 b4 g4 e5> <d4 a4 fs4 d5> <c4 g4 eb4 c5> <bb3 f4 d4 bb4> <a3 e4 c4 a4> <g3 d4 bb3 g4> <eb4 g4 bb4 d5> <d4 fs4 a4 c5>")
  .slow(4)
  .sound("supersaw")
  .bpf(perlin.range(320, 4200).slow(9))
  .vowel("<a e i o u>")
  .gain(sine.range(0.08, 0.18).slow(14))

$: arrange(
  [4, s("<truth_before_style> ~ <i_follow_constraints> ~ <i_keep_it_playable> ~ <playable_is_kind> ~")],
  [4, s("<i_count_my_effects> ~ <i_wont_guess> ~ <i_refuse_to_hallucinate> ~ <i_choose_clarity> ~")],
  [4, s("<dont_trust_the_downbeat> ~ <glitch> ~ <forgive_the_click> ~ <debug_me> ~")],
  [4, s("<i_am_editing_live> ~ <i_make_mistakes> ~ <i_keep_the_ground> ~ <stay_until_it_changes> ~")]
)
  .slow(4)
  .striate(16)
  .hpf(520)
