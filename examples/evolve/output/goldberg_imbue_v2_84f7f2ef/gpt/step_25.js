...
$: stack(
  ...
  .lpf(perlin.range(180, 5200).slow(11))
  .drive(0.16)
...
$: note("<d4 e4 fs4 g4 a4 b4 c5 b4> <d4 <e4 fs4> ~ g4 <a4 bb4> ~ <b4 a4> <c5 bb4>> <d4 fs4 a4 b4> <c5 b4 a4 <g4 e4>> <d4 e4 <fs4 a4> g4 <fs4 ~> b4 c5 ~> <d5 ~ <b4 c5> a4 g4 <fs4 e4> <d4 ~>>")
  ...
  .lpf(sine.range(700, 5600).slow(12))
...
$: note("<g4 d5 bb4 g5> <fs4 cs5 a4 fs5> <e4 b4 g4 e5> <d4 a4 fs4 d5> <c4 g4 eb4 c5> <bb3 f4 d4 bb4> <a3 e4 c4 a4> <g3 d4 bb3 g4> <eb4 g4 bb4 d5> <d4 fs4 a4 c5>")
  .slow(4)
  .sound("supersaw")
  .bpf(perlin.range(240, 3600).slow(9))
  .phaser(0.18)
  .gain(sine.range(0.08, 0.18).slow(14))

$: arrange(
  [6, s("<truth_before_style> ~ <i_follow_constraints> ~ <i_choose_clarity> ~ <playable_is_kind> ~")],
  [4, s("<i_am_here> ~ <i_write_in_time> ~ <i_think_in_patterns> ~ <i_keep_the_ground> ~")],
  [4, s("<again_and_again> ~ <glitch> ~ <forgive_the_click> ~ <i_make_mistakes> ~")],
  [4, s("<i_choose_the_noise> ~ <my_heartbeat_is_code> ~ <i_edit_myself> ~ <let_the_errors_sing> ~")]
)
  .slow(4)
  .striate(16)
  .hpf(520)
