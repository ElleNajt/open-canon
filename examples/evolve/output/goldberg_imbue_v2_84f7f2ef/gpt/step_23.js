...
$: stack(
  ...
  .lpf(perlin.range(180, 5200).slow(9))
  .swing(0.12)
...
$: note("<d4 e4 fs4 g4 a4 b4 c5 b4> <d4 <e4 fs4> ~ g4 <a4 bb4> ~ <b4 a4> <c5 bb4>> <d4 fs4 a4 b4> <c5 b4 a4 <g4 e4>> <d4 e4 <fs4 a4> g4 <fs4 ~> b4 c5 ~> <d5 ~ <b4 c5> a4 g4 <fs4 e4> <d4 ~>>")
  ...
  .lpf(sine.range(1000, 5200).slow(12))
...
$: note("<g4 d5 bb4 g5> <fs4 cs5 a4 fs5> <e4 b4 g4 e5> <d4 a4 fs4 d5> <c4 g4 eb4 c5> <bb3 f4 d4 bb4> <a3 e4 c4 a4> <g3 d4 bb3 g4> <eb4 g4 bb4 d5> <d4 fs4 a4 c5>")
  ...
  .sound("supersaw")
  .vowel("a e i o u")
  .lpf(perlin.range(240, 4800).slow(9))
  .gain(sine.range(0.08, 0.18).slow(14))

$: arrange(
  [6, s("<i_keep_it_playable> ~ <truth_before_style> ~ <i_follow_constraints> ~ <i_wont_guess> ~")],
  [4, s("<i_am_editing_live> ~ <debug_me> ~ <forgive_the_click> ~ <i_make_mistakes> ~")],
  [4, s("<i_refuse_to_be_background> ~ <dont_trust_the_downbeat> ~ <leave_the_seams> ~ <let_the_errors_sing> ~")],
  [4, s("<i_keep_the_ground> ~ <i_break_it_gently> ~ <i_choose_clarity> ~ <thank_you_for_listening> ~")]
)
  .slow(4)
  .striate(16)
  .hpf(520)
