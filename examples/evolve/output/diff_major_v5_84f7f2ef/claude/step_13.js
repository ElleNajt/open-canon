$: note("<c4 eb4 g4 bb4 d5 f5 ab5 c6>/3").sound("triangle")
  ...
  .delay(0.6).delaytime(0.333).gain(0.16)

$: note("c2 ~ g2 ~ eb2 ~ bb1 ~ f1 ~ c2 ~ g1 eb2 ~").sound("sawtooth")
  .lpf(saw.range(70, 1400).slow(9)).decay(0.9).sustain(0.01)
  .gain(0.14)
...
$: s("~ hh:2 ~ hh:1 ~ hh:3 ~ hh:1").degradeBy(0.25).gain(0.07)
  .hpf(3200).delay(0.3).delaytime(0.166)
