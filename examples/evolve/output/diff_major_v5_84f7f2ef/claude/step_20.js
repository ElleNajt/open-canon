...
$: note("c2 ~ g2 eb2 ~ bb1 ~ f1 c2 ~ ~ g1 ~ eb2 ~ ~").sound("sawtooth")
  .lpf(saw.range(80, 1100).slow(7)).decay(0.6).sustain(0.02)
  .gain(0.13)

$: note("<eb5 bb5 d6 g5 c6 f5 ab5>/13").sound("sine")
...
$: note("<f3 ab3 eb4 c4>/9 <bb3 g4 d4>/7").sound("pulse")
  .lpf(sine.range(320, 1900).slow(13)).attack(0.5).release(1.8).gain(0.11)