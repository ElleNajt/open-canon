...
$: note("c2 ~ g2 ~ eb2 ~ bb1 ~ f1 ~ c2 ~ g1 eb2 ~").sound("sawtooth")
  .lpf(saw.range(90, 1200).slow(7)).decay(0.7).sustain(0.02)
  .gain(0.13)
...
$: s("~ hh:2 ~ hh:1 ~ hh:3 ~ hh:1").degradeBy(0.3).gain(0.06)
  .hpf(2800).delay(0.25).pan(rand)

$: s("bd:3 ~ ~ bd:1 ~ bd:3 ~ ~").gain(0.12)
  .shape(0.3).lpf(90).room(0.3)

$: note("<f3 ab3 c4 eb4>/3 <bb3 d4 g4 f4>/5").sound("pulse")
  .lpf(sine.range(500, 1800).slow(5)).attack(0.5).release(1.2).gain(0.11)