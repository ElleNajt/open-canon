...
$: note("c2 ~ g2 ~ eb2 ~ bb1 f1 ~ c2 g1 ~ ~ eb2 ~ bb1").sound("sawtooth")
  .lpf(saw.range(80, 1200).slow(7)).decay(0.6).sustain(0.02)
  .gain(0.13)
...
$: note("<f3 ab3 c4 eb4>/5 <bb3 d4 g4 ab4>/7").sound("pulse")
  .lpf(sine.range(320, 1800).slow(9)).attack(0.5).release(1.8).gain(0.11)