...
$: note("<eb5 bb5 d6 g5 c6 f5 ab5 bb5 gb6 db6 ab5>/13").sound("sine")
  .attack(2.2).release(4).gain(0.08)
  .pan(sine.range(0.1, 0.9).slow(11))

$: s("~ hh:2 ~ hh:1 ~ hh:3 ~ hh:1 ~ hh:2").degradeBy(0.4).gain(0.07)
  .hpf(3200).delay(0.3).pan(rand)

$: s("bd:3 ~ ~ bd:1 ~ bd:2 ~ ~").gain(0.15)
  .shape(0.5).lpf(80).room(0.35)

$: note("<f3 ab3 eb4 c4 bb3 db4 gb3>/11 <g4 d4 f4 eb4 a4 bb4>/13").sound("pulse")
