...
$: arrange(
  [8, stack(
    note("<c4 [eb4 g4] [g4 c5] [eb4 g4] [d4 f4] [c4 ~]>")
      .sound("triangle")
      .lpf(perlin.range(800, 2600).slow(8))
      .echo(4, 0.25, 0.1)
...
$: arrange(
  ...
  [8, stack(
    ...
    s("~ oh ~ ~"),
    s("~ ~ cp ~")
  ).swing(0.1).hpf(210).crush(11).compressor("0.22:3.2:0.2:0.01:0.18").gain(0.36)],
  [8, stack(
    s("bd*2 [~ bd] bd"),
    s("~ sn ~ <sn sn>"),
    s("<oh*4 [hh*8 ~]>*2"),
    s("<cr ~ ~ ~>*2")
  ).swing(0.14).hpf(160).crush(10).compressor("0.22:3.2:0.2:0.01:0.18").gain(0.4)],
  [8, stack(
    s("<bd ~ bd ~>*2"),
    s("~ sn ~ sn"),
    s("<hh*8 [~ hh*16]>"),
    s("~ ~ cp ~"),
    s("~ ~ ~ cr")
  ).swing(0.16).hpf(190).crush(12).compressor("0.22:3.2:0.2:0.01:0.18").gain(0.34)]
)
