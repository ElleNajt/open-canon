...
$: arrange(
  [8, note("<c4 [eb4 g4] c5 [g4 eb4] [c4 ~] [d4 eb4]>").sound("triangle").lpf(sine.range(460, 2600).slow(8)).echo(3, 0.25, 0.22).every(4, x=>x.rev()).gain(0.24)],
  [8, note("<eb4 [g4 bb4] eb5 [bb4 g4] [f4 eb4] [eb4 ~ eb4]>").sound("piano").lpf(sine.range(640, 3800).slow(8)).delay(0.24).dt(0.375).dfb(0.25).gain(0.2)],
  ...
  [16, note("<c4 eb4 g4 c5> <bb3 d4 f4 bb4> <ab3 c4 eb4 ab4> <g3 bb3 d4 fs4>").sound("square").lpf(sine.range(320, 2900).slow(16)).phaser(0.16).every(8, x=>x.palindrome()).gain(0.2)]
)

$: note("<c2 ~ [c2 d2] g1> <c2 ~ [bb1 c2] g1> <ab1 ~ [ab1 bb1] eb1> <g1 ~ [g1 ab1] d1>").sound("sine").lpf(sine.range(75, 220).slow(16)).slide(0.08).triode(0.34).every(8, x=>x.transpose(12)).gain(0.2)
...
$: note("<c4 eb4 g4 bb4> <ab3 c4 eb4 g4> <f3 ab3 c4 eb4> <g3 bb3 d4 f4>").sound("supersaw").slow(4).djf(sine.range(0.14, 0.88).slow(16)).delay(0.22).room(0.32).gain(0.11)
