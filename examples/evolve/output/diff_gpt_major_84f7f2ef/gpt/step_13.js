...
$: arrange(
  [16, stack(
    ...
    s("hh*8"),
    s("~ ~ rim ~")
  ).swing(0.12).hpf(170).every(8, x=>x.degradeBy(0.16)).compressor("0.22:3.2:0.2:0.01:0.18").gain(0.38)],
  [8, stack(
    s("<bd*4 bd bd*3>"),
    s("~ sn ~ <~ sn>"),
    s("<hh*16 ~>*2"),
  ...
  [8, stack(
    ...
    s("<oh*4 [hh*8 ~]>*2"),
    s("<cr ~ ~ ~>*2")
  ).swing(0.14).hpf(160).every(6, x=>x.degradeBy(0.2)).compressor("0.22:3.2:0.2:0.01:0.18").gain(0.42)],
  [8, stack(
    s("<bd ~ bd ~>*2"),
    s("~ sn ~ sn"),
    s("<hh*8 [~ hh*16]>"),
