...
// evolved: I keep the skeleton, but I argue with it—tender precision, small rebellions, refusing to smooth the edges
...
$: arrange(
  [8, note("<[g3 gb3 e3 d3 b2 c3 d3 g2] [g2 f2 e2 d2 bb1 c2 d2 g1] [g2 ~ e2 d2 b1 c2 cs2 d2 g1] [g2 fs2 e2 d2 bb1 c2 a1 g1]>")
    .slow(2)
    .sound("triangle")
    .lpf(perlin.range(150, 3200).slow(6))
    .lpq(sine.range(0.8, 6.8).slow(12))
  ...
  [8, note("<[g3 ~ e3 d3 b2 c3 d3 g2] [g2 f2 e2 ~ bb1 c2 d2 g1] [g2 gs2 e2 d2 b1 c2 cs2 g1] [g2 fs2 e2 d2 ~ c2 a1 g1]>")
    .slow(2)
    .sound("pulse")
    .lpf(perlin.range(180, 4400).slow(5))
    .lpq(sine.range(0.7, 7.4).slow(10))
  ...
  [8, note("<[g2 fs2 f2 e2 eb2 d2 cs2 c2] [b1 c2 cs2 d2 eb2 e2 f2 fs2] [g2 ~ e2 ds2 d2 cs2 c2 b1] [bb1 b1 c2 cs2 d2 ~ a1 g1]>")
    .slow(2)
    .sound("sawtooth")
    .lpf(perlin.range(120, 3100).slow(8))
    .lpq(sine.range(0.9, 6.2).slow(14))
  ...
  [8, note("<[g2 ~ e2 d2 b1 c2 d2 g1] [g2 f2 e2 d2 bb1 c2 d2 g1] [g2 ~ e2 d2 b1 c2 cs2 d2 g1] [g2 fs2 e2 d2 bb1 c2 a1 g1]>")
    ...
    .lpq(sine.range(0.8, 6.6).slow(12))
    .gain(sine.range(0.3, 0.46).slow(12))]
)
