...
$: arrange(
  [12, stack(
    ...
    note("<[g1 ~ e1 d1 b0 c1 d1 g0] [g1 f1 e1 d1 bb0 c1 d1 g0] [g1 ~ e1 d1 b0 c1 cs1 d1 g0] [g1 f1 e1 d1 bb0 a0 g0 ~]>")
      ...
      .gain(0.095)
      .pan(tri.range(0.38, 0.62).slow(16))
  )],
  [8, stack(
    note("<[g2 ~ e2 d2 bb1 c2 eb2 d2 g1] [g2 gs2 e2 d2 b1 c2 cs2 d2] [g2 ~ e2 d2 bb1 c2 eb2 d2 g1] [g2 fs2 e2 d2 bb1 c2 a1 g1]>")
      .slow(2)
      .sound("pulse")
      .lpf(perlin.range(160, 5600).slow(10))
      .gain(0.28)
      .every(6, x => x.rev()),
    note("<[g1 ~ e1 d1 bb0 c1 ~ g0] [g1 ~ e1 d1 bb0 c1 cs1 d1 g0] [g1 ~ e1 d1 b0 c1 ~ g0] [g1 fs1 e1 d1 bb0 c1 a0 g0]>")
      .slow(2)
      .sound("sine")
      .lpf(sine.range(500, 1060).slow(11))
      .gain(0.092)
  ...
  [4, stack(
    ...
    note("<[g1 ~ e1 d1 b0] [c1 d1 g0 ~] [g1 ~ e1 d1 bb0] [c1 cs1 d1 g0]>")
      .slow(2)
      .sound("sine")
      .lpf(sine.range(430, 860).slow(8))
      .gain(0.094)
      .pan(tri.range(0.42, 0.58).slow(10))
  )]
)
