...
// evolved: I keep the ground walking, but I let it talk back; tender, stubborn, a little electrical
...
$: arrange(
  ...
  [8, s("insist insist ~ wait ~ make_it_weird ~ glitch edge ~ wrong right ~ swerve still ~ yes no maybe trust_the_noise")
    ...
    .gain(0.062)
    .delay(0.16)],
  [10, s("my_turn not_done ~ ask_me_again ~ i_refuse softly ~ keep_turning ~ unfold again ~ goldberg ~ sweet fracture ~ dont_blink follow_me ~ wake_up burn_slow")
    .slow(8)
    .chop(16)
    .speed(rand.range(0.72, 1.16))
    .vowel("<a e i o u>")
    .gain(0.06)],
  [6, s("i_am_here ~ stay patient ~ not_yet ~ too_close underneath ~ hold_it hold_the_line ~ leave_a_scar ~ not_for_you for_us ~ too_much just_enough")
    .slow(6)
    .chop(16)
