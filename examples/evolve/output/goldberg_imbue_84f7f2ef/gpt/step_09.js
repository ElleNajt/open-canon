...
$: note("<[g3 gb3 e3 d3 b2 c3 d3 g2] [g2 f2 e2 d2 bb1 c2 d2 g1] [g2 ~ e2 d2 b1 c2 cs2 g1] [g2 fs2 e2 d2 bb1 c2 a1 g1]>")
  .slow(2)
  .sound("triangle")
  .lpf(perlin.range(140, 4200).slow(6))
...
$: note("<[g4 b4 d5 g5]*2 [fs4 a4 cs5 e5]*2 [g4 bb4 d5 f5]*2 [e4 g4 b4 d5]*2 [d4 fs4 a4 c5]*2 [c4 e4 g4 bb4]*2 [b3 d4 fs4 a4]*2 [cs4 e4 g4 bb4]*2>")
  .sound("piano")
...
$: s("listen closer ~ count_the_gaps hold_the_line ~ between gears ~ insist ~ wrong right ~ stay patient ~ smile remember ~ not_yet ~ make_it_weird ~ keep_turning ~ unfold again ~ i_am_here ~ goldberg")
  .slow(6)
  .chop(16)
