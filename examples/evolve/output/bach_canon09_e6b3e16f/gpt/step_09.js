...
$: note("g2 ~!7 g3 ~!7 gb3 ~!7 e3 ~!7 d3 ~!7 b2 ~!7 c3 ~!7 d3 ~!7 g2 ~!7 g3 ~!7 gb3 ~!7 e3 ~!7 d3 ~!7 b2 ~!7 c3 ~!7 d3 ~!7 g2 ~!7 g3 ~!7 gb3 ~!7 e3 ~!7 d3 ~!7 b2 ~!7 c3 ~!7 d3 ~!7 g2 ~!7 g3 ~!7 gb3 ~!7 e3 ~!7 d3 ~!7 b2 ~!7 c3 ~!7 d3 ~!7 g2 ~!7 g3 ~!7 gb3 ~!7 e3 ~!7 d3 ~!7 b2 ~!7 c3 ~!7 d3 ~!7")
  ...
  .apply(
    x => lowerVoice(x)
      ...
      .sustain(0.12)
      .room(0.31)
      .lpf(sine.range(400, 1200).slow(20))
  )
  .pan(0.29)
  .degradeBy(0.11)
  .every(20, x => x.distort(0.25))
  .every(24, x => x.rev())
  .every(28, x => x.vowel("o"))
  .every(48, x => x.hpf(360))
  .every(64, x => x.delay(0.12).delaytime(0.16).delayfeedback(0.08))

// Removed previous 4th voice for clarity, evolving texture with wider pans, highpass and delay shifts