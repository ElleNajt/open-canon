...
// Track 2 — lower voice, contrasting color, rhythmic
$: note("g3 ~ d4 ~ b3 ~ d4 ~ g4 ~ d4 ~ b3 ~ d4 ~ g3 ~ d3 ~ e3 ~ c3 ~ b2 ~ d3 ~ g3 ~!3 d3 ~ a2 ~ g3 ~ d3 ~ g2 ~ g3 ~ b3 ~ d4 ~ g3 ~ e4 ~ c4 ~ a3 ~ c4 ~ g3 ~ a3 ~ d4 c4 b3 a3 g3 ~ b3 ~ d4 ~ g4 ~ d4 ~ b3 ~ g3 ~ d4 ~ d3 ~ g3 ~ a3 ~ d3 ~ e3 ~ g3 ~ d4 ~!3 d4 ~ a3 ~ g3 ~ d3 ~ g3 ~ b3 ~ d4 ~ g3 ~ e4 ~ c4 ~ a3 ~ c4 ~ g3 ~ a3 ~ d4 c4 b3 a3 g3 ~!7")
  .slow(264/8/4)
  .apply(lowerVoice)
  .pan(sine.range(0.55, 0.9).slow(38))
  .lpf(sine.range(540, 1650).slow(24))
  .hpf(80)
  .room(0.21)
  .degradeBy(0.11)
  .every(24, x => x.vowel("<a o>"))
  .every(48, x => x.rev())
  .every(64, x => x.distort(0.16))
  .every(41, x => x.tremolo(0.13).tremolosync(0.09))
...
$: note("e6 ~!4 b5 ~!4 d6 ~!4 g6 ~!4 b6 ~!4 e7 ~!4")
  ...
  .every(68, x => x.delay(0.27).delaytime(0.33).delayfeedback(0.19))

// Track 3 — removed for clarity and space