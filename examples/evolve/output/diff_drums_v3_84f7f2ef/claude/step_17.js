...
$: note("<[e2 ~ ~] [g2 ~ b1] [~ ~ b2] [fs2 ~ a2] [d2 ~ ~] [a1 ~ e2] [~ cs2 ~] [b1 ~ fs1]>").s("sawtooth")
  .lpf(sine.range(55, 480).slow(19)).decay(3.8).sustain(0.05).gain(0.26)

$: note("[~ cs4 ~] [b3 ~ e4] [~ gs4 ~] [fs4 ~ a4] [~ a4 ~] [e4 ~ b4] [~ ~ fs4] [gs4 ~ cs5]").s("sine")
  .delay(0.78).delaytime(0.48).pan(sine.range(0.2, 0.8).slow(11)).gain(0.14)
...
$: note("<[b4 ~ e5] [~ fs5 gs5] [~ ~ cs5] [a4 ~ ~] [a4 ~ d5] [~ e5 b4] [~ cs5 ~] [b4 ~ fs5]>").s("triangle")
  .lpf(1600).delay(0.68).delaytime(0.52).gain(0.11)