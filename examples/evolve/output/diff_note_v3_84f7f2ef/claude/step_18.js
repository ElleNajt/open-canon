$: note("<e2 [b1 ~] g1 [d2 a1] [~ e2] [fs1 b1] [g1 ~] a1>").sound("sawtooth")
  .lpf(sine.range(40,2200).slow(13)).lpq(7)
  .shape(0.62).gain(0.38).room(0.6)

$: note("[e3 ~] [b2 g3] [~ fs3] [a2 d3] [e3 ~] [g3 b3] <[d3 a3] [cs3 e3] [b2 fs3] [e3 g3] [a3 ~] [fs3 d4]>").sound("triangle")
...
$: note("e5*<3 5 4 2 3 6 7 4> [~ b5 ~] <g5 fs5 a5 ~ d6 ~ cs6 e6>").sound("pulse")
  .lpf(perlin.range(320,2800).slow(15)).lpq(5)
  .gain(0.12).pan(sine.range(0.2,0.8).slow(7))

$: note("<~ b5 ~ e6 [~ g6] ~ [d6 ~] ~ [fs6 ~] [~ e6] ~ [a5 ~] b5 ~ [g6 ~] ~ [~ cs6] ~ [b6 ~] ~>/4").sound("sine")
  .attack(3).release(14).gain(0.07).room(0.75)