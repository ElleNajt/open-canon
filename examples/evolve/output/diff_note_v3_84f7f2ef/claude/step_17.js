$: note("<e2 [b1 ~] g1 [d2 a1] [~ e2] [fs1 b1] [g1 ~] a1>").sound("sawtooth")
  ...
  .shape(0.58).gain(0.35).room(0.55)
...
$: note("e5*<3 5 4 2 3 6> [~ b5 ~] <g5 fs5 a5 ~ d6 ~>").sound("pulse")
  .lpf(perlin.range(280,2400).slow(13)).lpq(4)
  .gain(0.11).pan(sine.range(0.25,0.75).slow(5))

$: note("<~ b5 ~ e6 [~ g6] ~ [d6 ~] ~ [fs6 ~] [~ e6] ~ [a5 ~] b5 ~ [g6 ~] ~>/4").sound("sine")
