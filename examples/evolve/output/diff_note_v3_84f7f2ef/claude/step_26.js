...
$: note("[e3 ~] [b2 g3] [~ fs3] [a2 d3] [e3 ~] [g3 b3] <[d3 a3] [cs3 e3] [b2 fs3] [e3 g3] [a3 cs4] [fs3 b3]>").sound("triangle")
  .delay(0.62).dt("0.375 0.25 0.333").dfb(0.48)
...
$: s("[~ hh:1] hh:3? [hh:2 ~] [~ hh:5]? [hh:1 ~] ~ [hh:2? hh:4?] [~ hh:3]").sometimes(x => x.speed(0.65))
  .gain(perlin.range(0.08,0.16).slow(11))
  .hpf(5200).delay(0.28).pan(rand)

$: note("e5*<3 5 2 4> [~ b5 ~] <g5 fs5 a5 d6 cs6 b5 e6 gs5> [~ <fs5 b5 cs6>]").sound("pulse")
  .lpf(perlin.range(320,2800).slow(14)).lpq(5)
  .gain(0.12).delay(0.22).dt("0.333 0.25")

$: note("<~ b5 ~ e6 [~ g6] ~ [d6 ~] ~ [fs6 ~] [~ e6] ~ a5 ~ [b5 ~] ~ gs6 ~ [a5 cs6]>/4").sound("sine")
  .attack(3.5).release(10).gain(0.09).room(0.78)