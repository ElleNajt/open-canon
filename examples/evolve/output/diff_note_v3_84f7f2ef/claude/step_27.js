...
$: s("[~ hh:1] hh:3? [hh:2 ~] [~ hh:5]? [hh:1 ~] ~ [hh:2? hh:4?] [~ hh:3]").rarely(x => x.speed(0.5))
  .gain(perlin.range(0.06,0.14).slow(13))
  .hpf(6000).delay(0.32).pan(rand)

$: note("e5*<2 4 3 5> [~ b5 ~] <g5 fs5 a5 d6 cs6 b5 e6 gs5> [~ <fs5 b5 cs6>]").sound("pulse")
  .lpf(perlin.range(280,2400).slow(16)).lpq(6)
  .gain(0.1).delay(0.18).pan(sine.range(0.2,0.8).slow(9))
