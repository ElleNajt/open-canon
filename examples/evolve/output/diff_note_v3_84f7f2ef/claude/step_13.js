...
$: note("<~ b5 [~ ~] e6 [~ g6] [~ d6] ~ [cs6 ~] [~ e6] ~ [~ a5] b5 [~ ~] ~ [e6 ~] ~>/4").sound("sine")
  .attack(3.2).release(13).gain(0.11).room(0.8)