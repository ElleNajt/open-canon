...
$: s("bd ~ [~ bd] ~ [bd bd:1] [~ bd]").sometimes(x=>x.speed(0.75))
  .lpf(320).gain(0.38).shape(0.4).room(0.22)

$: note("<[b4 ~] [~ g5] [e5 d5] [~ fs5] [e5 ~] [g5 b4] [a5 ~] [~ fs5]>").sound("pulse")
  .slow(16).lpf(sine.range(350,3200).slow(13))
