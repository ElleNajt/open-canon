$: note("<e2 [b1 ~] g1 [d2 e2] [g1 a1] [fs1 b1] ~ [e2 b1]>").sound("sawtooth")
  ...
  .attack(0.5).decay(3).sustain(0.01)
  .gain(0.48).shape(0.78)
...
$: s("bd ~ [~ bd] ~ [bd bd:1] [~ bd]").sometimes(x=>x.speed(0.5))
  .lpf(100).gain(0.45).shape(0.65).room(0.28)

$: note("<[b4 ~] [~ g5] [e5 d5] [~ fs5] [e5 ~] [g5 b4] [a5 ~] [~ d5]>").sound("pulse")
  .slow(16).lpf(sine.range(250,1800).slow(7))
