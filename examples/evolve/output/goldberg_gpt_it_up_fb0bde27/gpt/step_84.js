...
$: stack(
  ...
  s("supersaw [triangle~] <saw square>").slow(13)
    .gain(0.12)
    .cutoff(sine.range(1200,3100).slow(13))
    .tremolo(0.42)
)

$: note("[c2 <d2~>] eb2 gs1~").slow(13)
  .sound("triangle")
  .gain(0.11)
  .lpf(perlin.range(1250,1800).slow(11))
  .degradeBy(0.30)
  .pan(sine.range(0.09,0.93).slow(10))
  .every(3, x => x.jux(y => y.rev()))