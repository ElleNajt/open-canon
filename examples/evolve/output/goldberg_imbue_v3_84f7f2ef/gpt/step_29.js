...
$: note("<g3 g2> [gb3 f3] <e3 eb3> [b2 ~] <c3 c2> [d3 d2] <g2 g1> <fs2 g2> [<g2 a2> <d2 ~>] [<c3 ~> <b2 ~>] <g2 <g3 g1>> [<eb3 d3> <c3 b2>]")
  .sound("triangle")
  .slow(2)
  .lpf(perlin.range(90, 2600).slow(12))
  .gain(0.26)
  .every(6, p => p.palindrome().transpose("<0 12 0 -12>").sometimesBy(0.35, q => q.rev()))

$: note("<g4 b4> [~ d5] <d4 fs4> <c4 e4> <b3 d4> [g4 ~] <c4 e4> <a3 c4> <d4 fs4> [~ <a4 cs5>] [<b4 d5> ~] <c5 <b4 d5>> [~ <d5 fs5>] [<c5 e5> ~]")
  .sound("piano")
  .slow(4)
  .lpf(perlin.range(1200, 9200).slow(10))
...
$: note("<g4 b4> <d5 fs4> <c5 e4> <b4 d4> <a4 c4> <g4 b3> <fs4 a3> <e4 g3> [<d4 fs3> ~] [<e4 g3> <fs4 a3>]")
  .sound("supersaw")
  .slow(8)
  .lpf(perlin.range(220, 6800).slow(16))
...
$: arrange(
  ...
  .hpf(720)
  .delay(0.3)
  .every(4, p => p.palindrome().sometimesBy(0.3, q => q.rev()))
...
$: note("<d5 b4> <a4 g4> <e5 a4> <fs5 d5> [~ b4] <g5 e5> <fs5 d5> <e5 cs5> <d5 b4> [~ <a4 cs5>] <b4 d5> <c5 a4> [<d5 b4> <g5 e5>]")
  ...
  .every(6, p => p.transpose("<0 12 7 -5>").palindrome().early(0.125))