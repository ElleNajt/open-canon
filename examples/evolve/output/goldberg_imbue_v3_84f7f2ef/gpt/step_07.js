...
$: note("<g3 g2> [gb3 f3] e3 <b2 b1> <c3 c4> <d3 d4> <g2 g3> <fs2 g2>")
  ...
  .gain(0.32)
  .every(8, p => p.palindrome().transpose(-12).degradeBy(0.1).juxBy(0.45, q => q.lpf(420).off(0.25, r => r.transpose(12).degradeBy(0.22).off(0.5, t => t.transpose(7).degradeBy(0.35)))))
...
$: note("<g4 a4> [d4 e4] <d4 fs4> <b3 c4> <d4 g4> <~ d4>")
  .slow(8)
  .sound("supersaw")
  .lpf(sine.range(200, 5600).slow(9))
  .phaser(0.18)
  .gain(0.11)
...
$: s("<i_am_here listen> ~ <again stay> <~ come_closer> ~ <breathe remember_me> <follow_the_space between_us> <do_not_fear hold_on>")
  .slow(8)
  .chop(32)
