$: note("<e2 b1 fs2 cs2 a1 e2 gs1 d2>").sound("sawtooth")
  .lpf(perlin.range(60,2200).slow(17)).lpq(8)
...
$: note("<[e4 b4 e5] [gs4 ~ fs4] [a4 cs5 a4] [~ gs4 b4]>").sound("sine")
  .attack(1.2).release(6).room(0.92)
  .pan(sine.range(0.1,0.9).slow(13)).gain(0.21)

$: s("[bd:2 ~] [~ bd:1] [bd:3 ~ ~] [~ bd:2 bd:1]").gain(0.44)
  .shape(0.48).lpf(140).room(0.32)

$: s("~ [hh:1 hh:2] [~ oh:2?] [hh:3 ~ hh:1]").gain(0.18)
  .hpf(4800).delay(0.32).pan(rand.range(0.2,0.8))

$: note("[~ e5 ~ b5] [gs5 ~ a5 ~] [~ fs5 e5 ~] [b5 ~ ~ cs6]").sound("pulse")
  .lpf(sine.range(320,3200).slow(13)).lpq(4)
