...
$: arrange(
  ...
  .sound("triangle")
  .slow(2)
  .lpf(perlin.range(120, 2900).slow(24))
...
$: arrange(
  ...
  .lpf(sine.range(900, 5200).slow(20))
  .echo(3, 0.5, 0.22)
  .gain(0.105)
...
$: arrange(
  ...
  .sound("supersaw")
  .lpf(sine.range(600, 7400).slow(16))
...
$: arrange(
  ...
  .slow(8)
  .lpf(sine.range(200, 3800).slow(20))
...
$: arrange(
  ...
  .sound("sine")
  .slow(8)
  .bpf(perlin.range(500, 3200).slow(10))
  .leslie(0.6)
  .gain(0.055)