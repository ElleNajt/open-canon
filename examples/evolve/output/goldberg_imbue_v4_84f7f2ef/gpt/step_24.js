...
$: arrange(
  ...
  .sound("triangle")
  .slow(2)
  .lpf(sine.range(140, 2400).slow(16))
...
$: arrange(
  ...
  .sound("piano")
  .juxBy(0.55, x => x.late(0.125).transpose(7).velocity(0.78).pan(0.82))
  .lpf(sine.range(800, 5400).slow(14))
  .delay(0.16)
  .gain(0.11)
...
$: arrange(
  ...
  .swing(0.2)
  .every(8, x => x.degradeBy(0.2).late(0.02))
  .gain(0.3)
...
$: arrange(
  ...
  .sound("pulse")
  .lpf(sine.range(900, 7200).slow(16))
  .echo(3, 0.25, 0.33)
...
$: arrange(
  ...
  .slow(8)
  .lpf(sine.range(260, 3400).slow(12))
...
$: arrange(
  ...
  .sound("sine")
  .slow(8)
  .bpf(sine.range(520, 2600).slow(10))
  .ring(0.22)
  .gain(0.055)