...
$: arrange(
  ...
  .sound("triangle")
  .slow(2)
  .lpf(sine.range(160, 2100).slow(16))
...
$: arrange(
    ...
    [16, note("[<g4 bb4 d5> <~ f4 a4 c5> <eb4 g4 bb4 d5> ~]*2 [<d4 fs4 a4> ~ <c4 g4 bb4> ~]")]
  )
  .sound("piano")
  .juxBy(0.62, x => x.late(0.125).transpose(7).velocity(0.84).pan(0.8))
  .delay(0.15)
  .dt(sine.range(0.2, 0.46).slow(12))
  .gain(0.11)
...
$: arrange(
  ...
  .sound("supersaw")
  .slow(4)
  .lpf(perlin.range(360, 8200).slow(16))
  .drive(0.25)
  .gain(0.08)
...
$: arrange(
  ...
  .sound("pulse")
  .lpf(sine.range(720, 4200).slow(12))
  .delay(0.2)
  .dt(0.375)
  .gain(0.06)
