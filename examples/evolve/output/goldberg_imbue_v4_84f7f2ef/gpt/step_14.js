...
$: arrange(
    ...
    [16, note("<g2 ~ gb2 f2> <eb2 d2 c2 bb1> <a1 ~ bb1 c2> <d2 ~ f2 g2>")],
    [16, note("<eb2 ~ g2 bb2> <d2 ~ f2 a2> <c2 ~ eb2 g2> <bb1 a1 ~ g1>")]
  )
  .sound("triangle")
  .slow(2)
  .lpf(sine.range(110, 3100).slow(12))
...
$: arrange(
    ...
    [16, note("[<g4 d5 bb4> ~]*2 [<c5 ~ a4 f5> ~ <bb4 d5 f5> ~]")],
    [16, note("[<g4 ~ bb4 d5> <~ f4 a4 c5>]*2 [<eb4 g4 bb4 ~> ~ <d4 fs4 a4 ~> ~]")]
  )
  .sound("piano")
  .juxBy(0.65, x => x.late(0.125).transpose(12).velocity(0.85).pan(0.78))
  .delay(0.14)
  .dt(0.375)
  .gain(0.11)
...
$: arrange(
  ...
  .sound("supersaw")
  .slow(4)
  .lpf(perlin.range(240, 6600).slow(18))
...
$: arrange(
    ...
    [16, s("hold_the_line ~ i_dont_sleep signal_in_the_dark follow_the_noise")]
  )
  .slow(8)
  .striate(8)
