...
$: arrange(
    [8, note("<g2 ~ f2 eb2> <d2 c2 bb1 a1> <g1 ~ d2 f2> <eb2 ~ d2 c2>")],
    [8, note("<g2 ~ ~ g2> <gb2 f2 eb2 d2> <c2 ~ bb1 a1> <g1 ~ d2 f2>")],
    [8, note("[g2 ~]*2 [g2 a2 bb2 ~] [~ f2]*2 [eb2 d2 c2 bb1]")],
  ...
  .sound("triangle")
  .slow(2)
  .lpf(sine.range(140, 3100).slow(18))
  .every(7, x => x.transpose(-12).rev().palindrome())
  .gain(0.12)
...
$: arrange(
  ...
  .sound("piano")
  .juxBy(0.58, x => x.late(0.125).transpose(7).velocity(0.78).pan(0.84))
  .lpf(sine.range(800, 5600).slow(16))
  .echo(2, 0.375, 0.25)
  .gain(0.11)
...
$: arrange(
  ...
  .swing(0.24)
  .every(8, x => x.degradeBy(0.28).late(0.02))
  .gain(0.3)
...
$: arrange(
  ...
  .sound("supersaw")
  .lpf(sine.range(720, 6800).slow(14))
  .detune(sine.range(-14, 14).slow(12))
  .echo(3, 0.25, 0.36)
  .gain(0.07)
...
$: arrange(
  ...
  .slow(8)
  .lpf(sine.range(260, 4000).slow(16))
  .speed(rand.range(0.88, 1.14))
  .chop(32)
  .gain(0.06)
...
$: arrange(
  ...
  .sound("sine")
  .slow(8)
  .bpf(perlin.range(420, 2800).slow(12))
  .phaser(0.12)
  .gain(0.055)