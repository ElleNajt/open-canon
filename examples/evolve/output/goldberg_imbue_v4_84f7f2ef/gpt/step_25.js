...
$: arrange(
  ...
  .sound("triangle")
  .slow(2)
  .lpf(sine.range(120, 2600).slow(18))
  .every(5, x => x.transpose(-12).palindrome())
  .gain(0.13)
...
$: arrange(
  ...
  .sound("piano")
  .juxBy(0.55, x => x.late(0.125).transpose(7).velocity(0.8).pan(0.82))
  .lpf(sine.range(700, 5200).slow(16))
  .delay(0.14)
  .gain(0.105)
...
$: arrange(
  ...
  .swing(0.22)
  .every(8, x => x.degradeBy(0.24).late(0.02))
  .gain(0.3)
...
$: arrange(
  ...
  .sound("supersaw")
  .lpf(sine.range(650, 6500).slow(14))
  .echo(3, 0.25, 0.36)
...
$: arrange(
  ...
  .slow(8)
  .lpf(sine.range(220, 3600).slow(16))
  .speed(rand.range(0.9, 1.12))
  .chop(32)
  .gain(0.06)
