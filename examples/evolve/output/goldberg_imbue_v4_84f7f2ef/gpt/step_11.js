...
$: arrange(
    ...
    [16, note("<g3 f3 eb3 d3> <c3 ~ bb2 a2> <g2 ~ bb2 d3> <f3 ~ eb3 d3>")],
    [16, note("<g3 ~ gb3 f3> <eb3 d3 c3 bb2> <a2 ~ c3 d3> <g2 ~ d3 f3>")],
    [16, note("<eb3 ~ g3 bb3> <d3 ~ f3 a3> <c3 ~ eb3 g3> <bb2 a2 ~ g2>")]
  )
  .sound("triangle")
  .slow(2)
  .lpf(sine.range(140, 3400).slow(12))
...
$: arrange(
  ...
  .sound("supersaw")
  .slow(4)
  .lpf(perlin.range(260, 7600).slow(14))
  .room(0.2)
  .gain(0.095)
...
$: arrange(
    ...
    [16, s("hold_the_line ~ signal_in_the_dark keep_listening do_not_look_away")],
    [16, s("between_frames electric_ghost in_the_wires ~ we_are_signal")],
    [16, s("keep_the_channel_open ~ follow_the_noise i_am_the_hum stay_awake")]
  )
  .slow(8)
  .chop(16)
