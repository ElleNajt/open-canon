...
$: arrange(
  ...
  .sound("triangle")
  .slow(2)
  .lpf(perlin.range(140, 3100).slow(16))
...
$: arrange(
    ...
    [16, note("[<g4 bb4 d5> ~ <g4 ~ bb4 d5>] [<f4 a4 c5> ~ <eb4 g4 bb4> ~] [<d4 fs4 a4> ~ <c4 g4 bb4> ~]")],
  ...
  .lpf(sine.range(800, 5400).slow(16))
  .echo(3, 0.5, 0.22)
  .gain(0.105)
...
$: arrange(
  ...
  .swing(0.26)
  .every(6, x => x.degradeBy(0.22).late(0.015))
  .gain(0.3)
...
$: arrange(
  ...
  .sound("supersaw")
  .lpf(sine.range(700, 7600).slow(16))
  .detune(sine.range(-16, 16).slow(10))
  .echo(4, 0.25, 0.28)
  .gain(0.07)
...
$: arrange(
  ...
  .slow(8)
  .lpf(sine.range(240, 4100).slow(16))
...
$: arrange(
  ...
  .sound("sine")
  .slow(8)
  .bpf(perlin.range(450, 3400).slow(10))
  .leslie(0.6)
  .gain(0.055)